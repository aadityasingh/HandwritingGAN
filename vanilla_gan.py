...
def show_result(num_epoch, show = False, save = False, path = 'result.png', isFix=False):
    ...
    if isFix:
        ...
        test_images = G(z_)
    # print(test_images[0, :].cpu().data.view(28, 28).numpy())
    G.train()
...
train_loader = torch.utils.data.DataLoader(
    datasets.EMNIST('temp', train=True, download=True, transform=transform),
